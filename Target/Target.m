classdef Target
    ...
    methods (Access = public)
        ...
        function ptArr = getPosition( obj, t )
            ...
            AEM = angle2dcm( deg2rad(ang(1)), deg2rad(ang(2)), 0 ); % calculates the direction cosine matrix given three sets of rotation angles specifying yaw, pitch, and roll. The rotation used in this function is a passive transformation between two coordinate systems.
